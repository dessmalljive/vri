...
public class WidgetEditors {
    public static class AstroImage {
        String name;
        String filename;
    ...
    public static class vriImgEdit extends JPanel {
        JComboBox<String> src_choice;
        JLabel src_label;
        vri parent;
        ...
        public vriImgEdit(vri p) {
            ...
            add(src_choice = new JComboBox<String>(src_data));
        ...
        void setImage(String s) {
            ...
            if (parent.UVpConvDisp.fft!=null && parent.UVpConvDisp.uvcov!=null) {
                ...
                if (parent.UVpConvDisp.fft==null) {
                    System.err.println("vriImgEdit: UVpConvDisp.fft is null!");
                } else if (parent.UVpConvDisp.uvcov==null) {
                    System.err.println("vriImgEdit: UVpConvDisp.uvcov is null!");
                }
            }
        }
    ...
    public static class vriAuxEdit extends JPanel 
    {
        vriAuxiliary aux;
        vriObservatory<?> obs;
        HAD.simpleHourAngleDec had;
        vri parent;
        ...
        public vriAuxEdit(vri p, vriAuxiliary a, vriObservatory<?> o) {
            ...
            had = new HAD.simpleHourAngleDec();
            aux.ha1 = had.getHa1(); 
            aux.ha2 = had.getHa2();
    ...
    public static class vriAuxEditJr extends vriAuxEdit 
    {
        vriAuxiliary aux;
        vriObservatory<?> obs;
        vri parent;
    ...
    public static class vriObsEdit extends JPanel {
        JComboBox<String> site_choice;
        JLabel lat_field;
        JLabel ant_field;
        JLabel dia_field;
        JLabel el_field;
    ...
    public static class vriUVpEdit extends JPanel {
        ...
        public vriUVpEdit(vri p) {
            ...
            String[] type_data = {"Ampl.", "Real", "Imag.",
                                  "Phase", "Colour"};
            add(type = new JComboBox<String>(type_data));
            type.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        String s = type.getSelectedItem().toString();
                        vriGreyDisp.PlotTypes t;
                        if (s.equals("Ampl.")) {
                            t = vriGreyDisp.PlotTypes.AMPL;
                        } else if (s.equals("Real")) {
                            t = vriGreyDisp.PlotTypes.REAL;
                        } else if (s.equals("Imag.")) {
                            t = vriGreyDisp.PlotTypes.IMAG;
                        } else if (s.equals("Phase")) {
                            t = vriGreyDisp.PlotTypes.PHASE;
                        } else {
                            t = vriGreyDisp.PlotTypes.COLOUR;
                        }
